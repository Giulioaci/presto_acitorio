    ...
    <div class="container-fluid vh-300">
        <div class="row h-75 align-items-center justify-content-center mb-3">
            <div class="col-12 text-center">
                ...
                <div class="my-3">
                    <img src="{{ asset('storage/images/immagine.jpg') }}" alt="Descrizione immagine" class="img-fluid rounded shadow img-fade">
                </div>

                <div class="container my-5">
                    <div class="row align-items-center justify-content-between">
                        <div class="col-md-6 text-center mb-4 mb-md-0">
                            <img src="{{ asset('storage/images/offerte.jpg') }}" alt="Offerte per il tuo business" class="img-fluid rounded shadow img-fade">
                        </div>
            ...
            <div class="my-5">
                <div class="row align-items-center">
                    <div class="col-md-6 text-center">
                        <img src="{{ asset('storage/images/immaginelogin.png') }}" alt="Immagine secondaria" class="img-fluid rounded shadow img-fade">
                    </div>
                ...
                <div class="container my-5">
                    <div class="row align-items-stretch">
                        <div class="col-md-6 mb-4 mb-md-0 text-center d-flex">
                            <img src="{{ asset('storage/images/pox.png') }}" alt="Gestione semplificata" class="img-fluid rounded shadow w-100 object-fit-cover img-fade">
                        </div>
                ...
                <div class="container my-5">
                    <div class="row align-items-start">
                        <div class="col-md-6 text-center mb-4 mb-md-0">
                            <img src="{{ asset('storage/images/chisiamo.jpg') }}" alt="Chi siamo" class="img-fluid rounded shadow img-fade">
                        </div>
                        <div class="col-md-6 d-flex flex-column justify-content-start">
                            <div>
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <img src="{{ asset('storage/images/saluto.png') }}" alt="Avatar" class="img-fade" style="width: 180px; height: 180px;">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                @if ($articles->count())
                    <div id="articlesCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="1500">
